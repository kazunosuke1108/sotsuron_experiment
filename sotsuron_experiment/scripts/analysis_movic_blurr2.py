...
# sudo pip3 -y uninstall opencv-python && sudo apt update && sudo apt install -y libgtk2.0-dev pkg-config && sudo pip3 install opencv-python
...
for img_path in images:
    ...
    cv2.imwrite("/home/hayashide/catkin_ws/src/sotsuron_experiment/analysis/velocity_error/big_data/hmn/test.jpg",human_img)
