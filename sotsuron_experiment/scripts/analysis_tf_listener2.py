...
class TfListener(ExpCommons):
    def __init__(self):
        ...
        # ファイルの立ち上げ
        self.tfrawcsvpath="/home/hayashide/catkin_ws/src/sotsuron_experiment/analysis/velocity_error"+"/"+f"{sys.argv[1]}_odom_to_zed_01x.csv"
    ...
    def main(self):
        while not rospy.is_shutdown():
            try:
                # odometry
                # TF
                (trans,rot) = self.listener.lookupTransform('/odom', '/zed_left_camera_optical_frame_tate', rospy.Time(0))
