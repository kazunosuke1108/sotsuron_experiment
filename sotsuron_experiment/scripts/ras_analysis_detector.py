...
for label in csv_labels["detectron2_joint_3d_4"]+["trunk_x","trunk_y","trunk_z","trunk_0","c_base_x","c_base_y","c_base_z","c_base_0","trunk_vx","trunk_vy","trunk_vz"]:
    if label[-1]=="x":
        if  ("gravity" not in label) & ("trunk" not in label) & ("c_base" not in label) & ("_v" not in label):
