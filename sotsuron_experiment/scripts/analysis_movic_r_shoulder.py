...
# odom
odom_to_zed_csv_path="C:/Users/hayashide/kazu_ws/sotsuron_experiment/sotsuron_experiment/results/_2023-12/_2023-12-21-10-22-39/_2023-12-21-10-22-39_od_raw.csv"
...
ax1.grid()
plt.title(f"relationship between odom & position ({os.path.basename(sys.argv[0])} _2023-12-21-10-22-39)")
