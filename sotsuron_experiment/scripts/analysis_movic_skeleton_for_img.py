...
#     [pred_keypoints,human_skeleton_img]=detector.onImage(image_mat=human_img,return_skeleton=True)
#     cv2.imwrite(f"/home/hayashide/catkin_ws/src/sotsuron_experiment/analysis/velocity_error/big_data/hmn_01x_skeleton/{os.path.basename(img_path)[:-4]}_skeleton.jpg",human_skeleton_img)
