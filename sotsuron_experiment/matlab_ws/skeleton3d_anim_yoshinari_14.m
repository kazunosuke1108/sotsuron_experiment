...
mat_general=readmatrix("C:\Users\hayashide\kazu_ws\sotsuron_experiment\sotsuron_experiment\results\20230619\csv\20230203_d_060_3_Yoshinari.csv");
mat_kp=readmatrix("C:\Users\hayashide\kazu_ws\sotsuron_experiment\sotsuron_experiment\results\20230619\csv\20230203_d_060_3_Yoshinari_kp.csv");
mat_odom=readmatrix("C:\Users\hayashide\kazu_ws\sotsuron_experiment\sotsuron_experiment\results\20230619\odom_csv\20230203_d_060_3_Yoshinari.csv");
...
thR=mat_general(:,9)-mat_general(1,9)+deg2rad(0);
...
for angle = transpose(angles)
    ...
    saveas(fig,"C:\Users\hayashide\kazu_ws\sotsuron_experiment\sotsuron_experiment\matlab_ws\20230203_d_060_3_Yoshinari_"+string(angle(1))+"_"+string(angle(2))+".png")
    video2=VideoWriter("C:\Users\hayashide\kazu_ws\sotsuron_experiment\sotsuron_experiment\matlab_ws\20230203_d_060_3_Yoshinari_"+string(angle(1))+"_"+string(angle(2))+".mp4",'MPEG-4');
    % video2=VideoWriter(savename_avi);
    video2.FrameRate=1/dt;
    open(video2);
    writeVideo(video2, frames);
    close(video2);
    saveas(fig,"C:\Users\hayashide\kazu_ws\sotsuron_experiment\sotsuron_experiment\matlab_ws\dev.png")
    clf;
    clearvars frames fig
end
