...
plot(t,l.mat(:,1),"b")
hold on
plot(t(ocl_idx),l.mat(ocl_idx,1),"ok")
...
plot(t,l.mat(:,2),"b")
hold on
plot(t(ocl_idx),l.mat(ocl_idx,2),"ok")
...
plot(t,l.mat(:,3),"b")
hold on
plot(t(ocl_idx),l.mat(ocl_idx,3),"ok")
...
hold on
plot(l.mat(ocl_idx,1),l.mat(ocl_idx,2),"ok")
...
saveas(fig,"C:\Users\hayashide\kazu_ws\sotsuron_experiment\sotsuron_experiment\matlab_ws\"+labelList(r.no)+"_timeFixed_ocl.png")